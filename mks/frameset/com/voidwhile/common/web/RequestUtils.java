...
import static com.voidwhile.common.web.Constants.POST;
import static com.voidwhile.common.web.Constants.UTF8;
...
public class RequestUtils {
	...
	/**
	 * 获取Request的参数值，如果为空返回默认值
	 * @param request
	 * @param name
	 * @param defaultValue
	 * @return
	 */
	public static String getParamValue(final HttpServletRequest request, final String name,
            final String defaultValue){
		final String value = getQueryParam(request, name);
