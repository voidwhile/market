...
(function(e, t) {
	...
	n.on = function(e, t) {
		...
		var i = c[e];
		if (i) if (t) for (var s = i.length - 1; s >= 0; s--) i[s] === t && i.splice(s, 1);
		else delete c[e];
		return n
	};
	...
	r.base = (P.match(rt) || ["", P])[1], r.dir = P, r.cwd = M, r.charset = "utf-8", r.preload = function() {
		...
		for (var t in e) {
			var i = e[t],
				o = r[t];
			if (o && s(o)) for (var a in i) o[a] = i[a];
			else u(o) ? i = o.concat(i) : t === "base" && (i.slice(-1) === "/" || (i += "/"), i = k(i)), r[t] = i
		}
		return h("config", e), n
	}
})(this), function() {
	var e = seajs.pluginSDK ? seajs.pluginSDK.util.loaderDir : seajs.data.base,
		t = e.lastIndexOf("/");
	t == e.length - 1 && (e = e.substr(0, t)), seajs.config({
		charset: "utf-8"
	}), seajs.config({
		paths: {
			bui: e
	...
	$.extend(BUI, {
		...
		isObject: o.call(null) === "[object Object]" ?
		function(e) {
	...
	var n = $.UA ||
	function() {
		var n = $.browser || t(navigator.userAgent),
			r = e(n.version),
			i = {
				ie: n.msie && r,
				webkit: n.webkit && r,
	...
	return e.ATTRS = {
		...
		_setTrigger: function() {
			...
			var e = this,
				...
				i = e.get("triggerActiveCls") || "",
				s = e.get("trigger"),
				o = e.get("delegateTrigger"),
				u = $(s);
	...
	return r.prototype = {
		...
		close: function() {
			...
			e.fire("closing", {
				...
				action: t
			}), t == "remove" ? e[t](!0) : e[t](), e.fire("closed", {
				action: t
			}))
		}
	}, r.View = n, r
			...
			return BUI.each(r, function(e) {
				...
				try {
					if (t === s) {
						...
						t = t.replace(i, "");
						var r = c(e.nodeValue);
						u[t] && BUI.isObject(r) ? BUI.mix(u[t], r) : u[t] = r
					}
				} catch (a) {
	...
	return t.ATTRS = {
		...
		setItemSelected: function(e, t) {
			...
			n.fire("beforeselectedchange", {
				item: e,
				selected: t
			}) !== !1 && n.setItemSelectedStatus(e, t)
		},
		...
		p = t.extend([t.Decorate, t.Tpl, t.ChildCfg, t.KeyNav, t.Depends], {
			...
			get: function(e) {
				var t = this,
					n = t.__view,
					r = t.__attrs[e],
					i = p.superclass.get.call(this, e);
	...
	}, BUI.extend(s, n), BUI.mixin(s, [t]), BUI.augment(s, {
		_read: function(e, t) {
			var n = this,
				r = e.pageable,
				i = e.start,
	...
	return r.ATTRS = {
		...
		load: function(e, n) {
			var r = this,
				i = r.get("proxy"),
				s = r.get("lastParams");
			t.mix(s, r.getAppendParams(), e), r.fire("beforeload", {
				params: s
		...
		filter: function(e) {
			var t = this,
				n = t.get("remoteFilter"),
				r;
			n ? t.load({
				filter: e
			}) : (t.set("filter", e), r = t._filterLocal(e), t.onFiltered(r, e))
		},
		...
		processLoad: function(e, t) {
			...
			return n.fire("beforeprocessload", {
				data: e
			}), n.fire("beforeProcessLoad", e), e[r] || e.exception ? (n.onException(e), !1) : !0
		},
	...
	return u.ATTRS = {
		...
		_getDirtyData: function() {
			...
			return t.get("url") ? {
				...
				add: e.get("newRecords"),
				update: e.get("modifiedRecords"),
				remove: e.get("deletedRecords")
			}
		},
		onSave: function(e, t, n) {
			var r = this,
				i = r.get("hasErrorProperty");
			if (n[i] || n.exception) {
				r.onException(n);
				return
			}
			r._clearDirty(e, t), r.fire("saved", {
				type: e,
				saveData: t,
				data: n
			}), r.get("autoSync") && r.load()
		},
		...
		update: function(e, t, n) {
			var r = e,
				...
				n = null,
				s = null;
			t && (n = n || i._getDefaultMatch(), s = i.findIndexBy(e, n), s >= 0 && (r = i.getResult()[s])), r = BUI.mix(r, e), !o(r, i.get("newRecords")) && !o(r, i.get("modifiedRecords")) && i.get("modifiedRecords").push(r), i.fire("update", {
				record: r
			})
		},
		...
		o = n.Controller.extend([i.Position, i.Align, i.Close, i.AutoShow, i.AutoHide], {
			...
			show: function() {
				...
				var e = this,
					...
					i = t.effect,
					s = t.duration;
				e.get("rendered") || (e.set("visible", !0), e.render(), e.set("visible", !1), n = e.get("el")), r === "visibility" && (e.set("visible", !0), n.css({
					display: "none"
				}));
				switch (i) {
				case "linear":
			...
			hide: function() {
				function s() {
					e.get("visibleMode") === "visibility" && n.css({
						display: "block"
	...
	var t = e("bui/common"),
		...
		r = t.UA,
		i = e("bui/list/domlist"),
		s = e("bui/list/keynav"),
		o = e("bui/list/sortable"),
		u = t.prefix + "list-item",
		a = t.Component.View.extend([i.View], {
		...
		f = t.Component.Controller.extend([i, n.Bindable, s, o], {
			bindUI: function() {
				var e = this,
					t = e.get("itemCls"),
					n = e.get("view").getItemContainer();
			...
			ATTRS: {
				...
				itemTpl: {
					view: !0,
					value: '<li role="option" class="' + u + '">{text}</li>'
				},
				tpl: {
					value: "<ul></ul>"
				},
		...
		n = t.extend({
			bindUI: function() {
				...
				e.on("show", function(t) {
					...
					if (e.get("autoSetValue")) {
						var n = e.get("valueField") || e.get("textField") || e.get("curTrigger"),
							r = $(n).val();
			...
			initControlEvent: function() {
				...
				t.on(e.get("changeEvent"), function(t) {
					var r = e.get("curTrigger"),
						i = e.get("textField") || r || n,
						s = e.get("valueField"),
						o = e.getSelectedValue(),
						u = !1;
					if (i) {
						var a = e.getSelectedText(),
							f = $(i).val();
		...
		i = n.extend({
			...
			PARSER: {
				datePicker: function(e) {
					var n = this,
						r = n.get("datePicker") || {};
					return e.hasClass("calendar-time") && t.mix(r, {
						showTime: !0
					}), r
				}
			}
	...
	return i.ATTRS = {
		...
		clearErrors: function(e, n) {
			...
			n && t.each(i, function(t) {
				t.clearErrors && (t.field ? t.clearErrors(e) : t.clearErrors(n, e))
		...
		o = r.extend({
			...
			_initSubmitMask: function() {
				...
				r === n.AJAX && i && t.use("bui/mask", function(n) {
					...
					i = new n.LoadMask(t.mix({
						el: e.get("el")
					}, r)), e.set("submitMask", i)
				})
			},
	...
	var t = e("bui/common"),
		...
		a = "data-id",
		f = n.View.extend([r.ListItemView, r.CollapsableView], {
		...
		l = n.Controller.extend([r.ListItem, r.Collapsable], {
			renderUI: function() {
				var e = this,
					n = e.get("el"),
					r = e.get("id"),
			...
			PARSER: {
				subMenu: function(e) {
					var n = e.find("ul"),
						r;
					return n && n.length && (r = t.Component.create({
						srcNode: n,
						xclass: "pop-menu"
					}), n.appendTo("body")), r
				}
	...
	return t.ATTRS = {
		...
		_getPanel: function(e) {
			var t = this,
				...
				r = BUI.substitute(t.get("panelTpl"), e);
			return $(r).appendTo(n)
		}
	}), t
		...
		c = r.Controller.extend({
			...
			_closeItem: function(e) {
				var t = this,
					n = t._getIndex(e),
					r = t.getActivedItem(),
					i = t.get("preItem") || t._getItemByIndex(n - 1),
			...
			_setItemActived: function(e) {
				var t = this,
					n = t.getActivedItem();
				if (e === n) return;
				n && n.set("actived", !1), t.set("preItem", n), e && (e.get("actived") || e.set("actived", !0), e.get("visible") && t._scrollToItem(e), t.fire("activeChange", {
					item: e
	...
	var t = e("bui/common"),
		n = e("bui/tab/tabitem"),
		r = e("bui/tab/panelitem"),
		i = "bui-tab-item-text",
		s = t.Component,
		o = n.View.extend([s.UIBase.Close.View], {
			_uiSetTitle: function(e) {
				var t = this,
					n = t.get("el"),
					r = n.find("." + i);
		...
		u = n.extend([r, s.UIBase.Close], {}, {
			ATTRS: {
				...
				tpl: {
					value: '<span class="' + i + '">{text}{title}</span>'
				},
				closeable: {
					value: !1
				},
		...
		m = t.extend([r], {
			initializer: function() {
				...
				n ? BUI.each(n, function(n, r) {
					BUI.isString(n) && (BUI.Array.contains(n, d) ? n = e._getButtonItem(n) : BUI.Array.contains(n, v) ? n = e._getTextItem(n) : n = {
						xtype: n
					}), t.push(n)
			...
			ATTRS: {
				...
				curPageTpl: {
					value: '\u7b2c <input type="text" autocomplete="off" class="' + i + 'pb-page" size="20" value="{curPage}" name="inputItem"> \u9875'
				},
				totalCountTpl: {
	...
	var t = e("bui/common"),
		...
		w = p.Controller.extend({
			...
			_updateTodayBtnAble: function() {
				...
				if (!e.get("showTime")) {
					var t = e.get("footer"),
						n = e.get("panel").get("view"),
						r = v(),
						i = t.getItem("todayBtn");
	...
	var t = e("bui/common"),
		...
		s = n.extend({
			...
			setSelectedValue: function(e) {
				...
				var t = this,
					n = this.get("calendar"),
					r = i.parse(e, t.get("dateMask"));
				r = r || new Date((new Date).setSeconds(0)), n.set("selectedDate", i.getDate(r));
				if (t.get("showTime")) {
					var s = this.get("lockTime"),
						o = s && s.hour ? s.hour : r.getHours(),
						u = s && s.minute ? s.minute : r.getMinutes(),
						a = s && s.second ? s.second : r.getSeconds();
	...
	var t = e("bui/common"),
		...
		H = o.SimpleListView.extend({
			...
			_getCellText: function(e, n, r) {
				var i = this,
					s = e.get("dataIndex"),
					o = e.get("cellTpl") || i.get("cellTextTpl"),
					u = i._getCellInnerText(e, s, n, r);
				return t.substitute(o, {
					text: u,
					tips: i._getTips(e, s, n)
				})
			},
		...
		B = o.SimpleList.extend({
			...
			ATTRS: {
				...
				cellTextTpl: {
					view: !0,
					value: '<span class="' + k + ' " title = "{tips}">{text}</span>'
				},
				events: {
					value: {
						aftershow: !1,
	...
	define("bui/grid/plugins", ["bui/common", e + "selection", e + "cascade", e + "cellediting", e + "rowediting", e + "autofit", e + "dialogediting", e + "menu", e + "summary", e + "rownumber"], function(t) {
		var n = t("bui/common"),
			r = t(e + "selection"),
			i = {};
		return n.mix(i, {
	...
	return t.extend(n, t.Base), n.ATTRS = {}, t.augment(n, {
		bindUI: function(e) {
			var t = this,
				n;
		...
		_autoFit: function(e) {
			var t = e.get("render"),
				n;
			e.set("visible", !1), n = $(t).width(), e.set("visible", !0), e.set("width", n)
		}
	}), n
	...
	return BUI.extend(r, BUI.Base), r.ATTRS = {
		...
		bindEidtor: function(e) {
			...
			e.on("accept", function() {
				var n = t.get("record");
				t.updateRecord(r, n, e), t.fire("accept", {
					editor: e,
					record: n
		...
		showEditor: function(e, t) {
			...
			e.show(), n.focusEditor(e, t.field), n.set("curEditor", e), n.fire("editorshow", {
				editor: e
			})
		},
	...
	return i.ATTRS = {
		...
		beforeShowEditor: function(e, n) {
			...
			e.set("width", u.width()), t.each(s, function(e) {
				var t = e.get("dataIndex"),
					n = o.getField(t);
				if (!e.get("visible")) n && n.set("visible", !1);
				else {
	...
	return S.ATTRS = {
		...
		setNodeChecked: function(e, n, i) {
			...
			if (s.isChecked(e) !== n || s.hasStatus(e, "checked") !== n) {
				f = s.findElement(e), f ? (s.setItemStatus(e, u, n, f), a ? s._resetPatialChecked(e, n, n, f) : n && o && s.isChecked(o) != n && s.setNodeChecked(o, n, !1)) : s.isItemDisabled(e) || s.setStatusValue(e, "checked", n), o && (s.isChecked(o) != n ? s._resetParentChecked(o) : a && s._resetPatialChecked(o, null, null, null, !0));
				if (n && !a && (s.isChecked(o) || o == s.get("root"))) {
					var l = o.children;
					r.each(l, function(t) {
			...
			}!e.leaf && i && r.each(e.children, function(e, t) {
		...
		_initChecked: function(e, t) {
			var n = this,
				i = n.get("checkType"),
				s = n.get("checkedField"),
				o = n.get("multipleCheck"),
				u = n.get("checkableField"),
				a;
			if (i === f.NONE) {
				e[u] = !1, e[s] = !1;
				return
			...
			a = e.parent, n.isChecked(e) || (a && n.isChecked(a) && (o || !n._hasChildChecked(a)) && n.setStatusValue(e, "checked", !0), (e.children && e.children.length && n._isAllChildrenChecked(e) || !o && n._hasChildChecked(e)) && n.setStatusValue(e, "checked", !0)), t && r.each(e.children, function(e) {
				n._initChecked(e, t)
			})
		},
		...
		_resetParentChecked: function(e) {
			...
			var t = this,
				...
				r = n ? t._isAllChildrenChecked(e) : t._hasChildChecked(e);
			t.setStatusValue(e, "checked", r), t.setNodeChecked(e, r, !1), n && t._resetPatialChecked(e, r, null, null)
		},
		__bindUI: function() {
			var e = this,
				t = e.get("el"),
				n = e.get("multipleCheck");
			e.on("itemclick", function(t) {
				var n = $(t.domTarget),
					r = t.element,
					i = t.item;
				...
				var r = t.item,
					i = t.domTarget;
				e._resetIcons(r, i), e.isCheckable(r) && n && e._resetPatialChecked(r, null, null, i), e._isExpanded(r, i) && e._showChildren(r)
			}), e._initExpandEvent()
		},
		...
		_getIconsTpl: function(e) {
			...
			return o.push(t._getExpandIcon(e)), o.push(t._getCheckedIcon(e)), o.push(t._getNodeTypeIcon(e)), r.substitute(s, {
				icons: o.join("")
			})
		},
		...
		_hideChildrenNodes: function(e) {
			...
			}), t.get("expandAnimate") ? (i = $(i), i.animate({
				height: 0
			}, function() {
				t.removeItems(n)
			})) : t.removeItems(n)
	...
	var t = e("bui/common"),
		n = e("bui/list").SimpleList,
		r = function() {};
	return r.ATTRS = {}, t.augment(r, {
		getSelection: function() {
			var e = this,
				t = e.getStatusField("selected"),
				r;
	...
	var t = e("bui/common"),
		...
		s = n.SimpleList.View.extend({
			getItemTpl: function(e, n) {
				var r = this,
					i = r.get("itemTplRender"),
					s = e.leaf ? r.get("leafTpl") : r.get("dirTpl");
				return i ? i(e, n) : t.substitute(s, e)
			}
		}, {
			xclass: "tree-menu-view"
		}),
		o = n.SimpleList.extend([r, i], {}, {
			ATTRS: {
				itemCls: {
					value: t.prefix + "tree-item"
				},
