...
<form id="editForm" class="easyui-form" method="post" data-options="novalidate:true">
	<table id="cmdTab" class="tableBox" border="0" width="100%" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td><input class="easyui-textbox" type="text" id="title" name="title" style="width:250px" missingMessage="标题不能为空！" data-options="required:true" /></td>
		...
		<tr>
			...
			<td><input class="easyui-textbox" type="text" id="url" name="url" style="width:250px"  /></td>
			<th width="10%" align="right">类型:</th>
			<td>
			<select id="adAdvertType" name="adAdvertType" >
			<option value="1">轮播广告</option>
			<option value="2">普通广告</option>
		...
		<tr>
			<td colspan="4"><script type="text/plain" id="description" name="description"
