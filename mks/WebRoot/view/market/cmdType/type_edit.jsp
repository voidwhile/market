...
<body>
  ...
  <form id="editForm" class="easyui-form"  method="post">  
  	<input type="hidden" name="cmdType" value="${type.cmdType }" id="cmdType"/>
  	<table class="tableBox" width="100%" border="0" cellspacing="1">
	       <tr>
		        <th><label>父级分类：</label></th>
		        <td><label>${parent.typeName}</label></td>
		   </tr>
		   <tr>
		    	<th><label >子分类：</label></th>
		        <td><input type="text" id="typeName" name="typeName" class="easyui-validatebox textbox" data-options="required:true" missingMessage="请输子分类！" value="${type.typeName }"   /></td>
		    </tr>
	         <tr>
				...
				<tr>
					...
					<td colspan="3" id="picShow"><img width='25' height='25' src='${imgUrl }${type.imgPath }' onclick='showPic(this.src)'/></td>
				</tr>
	 </table>
