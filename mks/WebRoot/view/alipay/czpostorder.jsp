...
<head>
    ...
    <script src="${path}/public/weixin/js/jquery.1.11.1.js"></script>
    <style>
...
<div class="wrapper-list">
        ...
        <dd>
            <dl>
                ...
                <dd class="kv-line-r dd-padding">
                    <h6>总额：</h6>
                    <p>
                        <strong class="color-stronger highlight-price">${fee}元</strong>
                    </p>
                </dd>
            </dl>
        </dd>
    ...
    <div id="pay-methods-panel" class="pay-methods-panel">
        <form id="pay_form" method="POST"  action="${path}/alipay/pay.do">			
		        <input type="hidden" name="outTradeNo" value="${outTradeNo}"/>	
		        <input type="hidden" name="body" value="${body}"/>	
		        <input type="hidden" name="productCode" value="${productCode}"/>	
		        <input type="hidden" name="totalAmount" value="${totalAmount}"/>	
		        <input type="hidden" name="subject" value="${subject}"/>		
		          <input type="hidden" name="timeoutExpress" value="100"/>			 			          
            <div class="wrapper buy-wrapper">
                <a href="javascript:void(0);"
                   class="J-btn-submit btn mj-submit btn-strong btn-larger btn-block" onclick="pay()">确认支付</a>
            </div>
        </form>
    </div>
</div> 
