...
<body>
  <form id="editForm" class="easyui-form"  method="post">  
  	...
  	<input type="hidden" value="1" name="status" id="noticestatus"/>
  	<table class="tableBox" width="100%" border="0" cellspacing="1">
	       <tr>
		        <th><label>公告标题：</label></th>
		    	<td><input type="text" maxlength="100" style="width:300" id="title" name="title" class="easyui-validatebox" data-options="required:true"/>
		    	    是否发布<input type="checkbox" id="isCheck" checked="checked">
		   ...
		   <tr>
		        ...
		        <td>
				  <textarea id="editor_id" name="content" style="width:660px;height:280px;" class="easyui-validatebox" data-options="required:true"></textarea>
		        </td>
		    </tr>
		    <tr>
		        <th><label>发送人员：</label></th>
		    	<td style="height:100px;">
	                <ul id="easyTree" class="easyui-tree" data-options="url:'${path}/admin/user/tree.do',animate:true,checkbox:true,lines:true,loadMsg:'数据正在加载中'">
	                </ul>
	                <input id="list" type="hidden" name="notifyUsers"/>
		    	</td>
		   </tr>
